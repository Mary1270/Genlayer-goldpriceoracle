...
class GoldPriceOracle(gl.Contract):
    ...
    def _annotate_sources(self, source_urls):
        ...
        provenance metadata BEFORE any network access. Identical
        logic/rationale to OilPriceOracle."""
        seen_domains = set()
        annotated = []
    ...
    def create_agreement(
        ...
        # OilPriceOracle's - see create_agreement's docstring above
        # and the README's "Source Policy Commitment" section.
        # ------------------------------------------------------------
